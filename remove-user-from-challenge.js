...
const User = require('./fitapp-backend/models/User');
const ChallengeParticipant = require('./fitapp-backend/models/ChallengeParticipant');
const Challenge = require('./fitapp-backend/models/Challenge');
