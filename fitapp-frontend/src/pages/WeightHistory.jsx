            ...
            <div className="bg-white rounded-xl px-4 py-4 shadow-sm">
              ...
              <div className="px-[2px] pb-8">
                ...
                <svg ref={svgRef} width="100%" height="100%" viewBox={`0 0 ${chartWidth} 320`} preserveAspectRatio="none">
                  ...
                  {/* Today indicator lines only - circles rendered outside SVG */}
                  {(() => {
                    ...
                    return points.map((point) => {
                      ...
                      // Convert to screen coordinates, then to SVG coordinates
                      ...
                      const y = topBuffer + availableHeight - (normalizedWeight * availableHeight)
                      
                      return (
                        <line
                          key={(point.date instanceof Date ? point.date : new Date(point.date)).toISOString()}
                          x1={x}
                          y1={y}
                          x2={x}
                          y2={y - 20}
